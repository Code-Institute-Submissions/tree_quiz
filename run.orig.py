...
def prep_next_q(start, correct, message, cur_player_data, all_players_data):
    """
...
def start():
    ...
    if request.method == "POST" and username != "":
        ...
        glob_all_players_data = all_players_data
        glob_cur_player_data = cur_player_data
        ...
        return prep_next_q(True, True, message, cur_player_data, all_players_data)
    ...
    if request.method == "POST":
        ...
        if cur_question < 10:
            ...
            if check_answer(cur_question, answer) == True:
                ...
                return prep_next_q(False, True, message, cur_player_data, all_players_data)
            ...
            # If wrong on first attempt, give second attempt
                ...
                return prep_next_q(False, False, message, cur_player_data, all_players_data)
